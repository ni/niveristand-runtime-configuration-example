...
- **API Documentation**
  ...
  - [Runtime Configuration File](https://github.com/ni/Runtime-Configuration-Support-Example/wiki/Runtime-Configuration-File)

## License

The Runtime Configuration Support Example Custom Device is licensed under an MIT-style license (see [LICENSE](./LICENSE)). Other incorporated projects may be licensed under different licenses. All licenses allow for non-commercial and commercial use.
